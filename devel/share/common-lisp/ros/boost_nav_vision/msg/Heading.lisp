...
(cl:in-package boost_nav_vision-msg)
...
(cl:defclass <Heading> (roslisp-msg-protocol:ros-message)
  ((crosstrackError
    :reader crosstrackError
    :initarg :crosstrackError
    :type cl:float
    :initform 0.0)
   (headingError
    :reader headingError
...
(cl:defmethod cl:initialize-instance :after ((m <Heading>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Heading)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name boost_nav_vision-msg:<Heading> is deprecated: use boost_nav_vision-msg:Heading instead.")))

(cl:ensure-generic-function 'crosstrackError-val :lambda-list '(m))
(cl:defmethod crosstrackError-val ((m <Heading>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader boost_nav_vision-msg:crosstrackError-val is deprecated.  Use boost_nav_vision-msg:crosstrackError instead.")
  (crosstrackError m))

(cl:ensure-generic-function 'headingError-val :lambda-list '(m))
(cl:defmethod headingError-val ((m <Heading>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader boost_nav_vision-msg:headingError-val is deprecated.  Use boost_nav_vision-msg:headingError instead.")
  (headingError m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Heading>) ostream)
  "Serializes a message object of type '<Heading>"
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'crosstrackError))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Heading>) istream)
  "Deserializes a message object of type '<Heading>"
    ...
    (cl:setf (cl:slot-value msg 'crosstrackError) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Heading>)))
  ...
  (cl:format cl:nil "float64 crosstrackError~%float64 headingError~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Heading)))
  "Returns full string definition for message of type 'Heading"
  (cl:format cl:nil "float64 crosstrackError~%float64 headingError~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Heading>))
  ...
  (cl:list 'Heading
    (cl:cons ':crosstrackError (crosstrackError msg))
