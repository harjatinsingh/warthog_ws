...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /home/robocrop/warthog_ws/src/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /home/robocrop/warthog_ws/devel)
  ...
  set(velodyne_driver_INSTALL_PREFIX /home/robocrop/warthog_ws/install)
...
if(NOT "/home/robocrop/warthog_ws/devel/include;/home/robocrop/warthog_ws/src/velodyne/velodyne_driver/include " STREQUAL " ")
  set(velodyne_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/robocrop/warthog_ws/devel/include;/home/robocrop/warthog_ws/src/velodyne/velodyne_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robocrop/warthog_ws/src/velodyne/velodyne_driver/${idir}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
