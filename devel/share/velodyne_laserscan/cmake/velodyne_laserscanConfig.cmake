...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_laserscan_SOURCE_PREFIX /home/robocrop/warthog_ws/src/velodyne/velodyne_laserscan)
  set(velodyne_laserscan_DEVEL_PREFIX /home/robocrop/warthog_ws/devel)
  ...
  set(velodyne_laserscan_INSTALL_PREFIX /home/robocrop/warthog_ws/install)
...
if(NOT "/home/robocrop/warthog_ws/devel/include " STREQUAL " ")
  set(velodyne_laserscan_INCLUDE_DIRS "")
  set(_include_dirs "/home/robocrop/warthog_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_laserscan' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robocrop/warthog_ws/src/velodyne/velodyne_laserscan/${idir}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${velodyne_laserscan_dep}_FOUND)
      find_package(${velodyne_laserscan_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${velodyne_laserscan_dep} REQUIRED ${depend_list})
  endif()
