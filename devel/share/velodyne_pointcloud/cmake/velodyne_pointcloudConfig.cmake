...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/robocrop/warthog_ws/src/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/robocrop/warthog_ws/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/robocrop/warthog_ws/install)
...
if(NOT "/home/robocrop/warthog_ws/devel/include;/home/robocrop/warthog_ws/src/velodyne/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/robocrop/warthog_ws/devel/include;/home/robocrop/warthog_ws/src/velodyne/velodyne_pointcloud/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robocrop/warthog_ws/src/velodyne/velodyne_pointcloud/${idir}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>' to fix it.")
    endif()
