...
//float xPoints [] = {624705.943039,624656.169622,624572.14121};
//float yPoints [] = {4692392.58087,4692381.46184,4692363.29321};

float xPoints [] = {624604.147324,624612.380713, 624626.037109,624638.354223,624649.2991,624660.211003,624672.528095,624684.845181,624697.16226,624708.107105};
float yPoints [] = {4692385.72581,4692385.87243,4692389.81813,4692391.88875,4692393.93495,4692397.83184,4692399.90252,4692401.97323,4692404.04396,4692406.09025};
...
void odomCallback(const nav_msgs::Odometry::ConstPtr& odomMsg)
{
	...
	ROS_INFO_STREAM("Distance to next waypoint " << dist);
...
int main(int argc, char **argv)
{
	...
	waypoint_pub = n.advertise<std_msgs::Float64MultiArray>("gps/waypoint_reached", 10);
